---
title: Capture all Flabébé Forms
...
![Flabébé spawns are marked red](/catch/flabebe-spawns.png)
Another common spawn location is **South** of **Cortondo**, close to the Ocean.
![Flabébé spawns are marked red](/catch/flabebe-spawns-2.png)

<Aside type="note">Spawn locations are marked with red dots.</Aside>
